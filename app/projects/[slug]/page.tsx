    ...
    return (
        <div className="text-white min-h-screen pt-32">
            ...
            <section className="max-w-4xl mx-auto px-8 mb-16">
                ...
                {/* GitHub & Certificate Buttons - LADO A LADO */}
            ...
            <section className="max-w-4xl mx-auto px-8 mb-20">
                <div className="flex items-center justify-center gap-4">
                    <Link
                        href="/projects"
                        className="flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full font-jost font-normal hover:bg-gray-200 transition-colors"
                    >
                        BACK TO PROJECTS
                    </Link>

                    <button aria-label="back" className="flex items-center justify-center bg-white text-black w-14 h-14 rounded-full hover:bg-gray-400 transition-colors">
